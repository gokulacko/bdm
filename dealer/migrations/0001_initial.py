# Generated by Django 2.1.3 on 2019-01-08 08:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bdm', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dealer.Bdm')),
                ('brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dealer.Brand')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file_name', models.FileField(default='settings.MEDIA_ROOT/dealerprice/anonymous.png', upload_to='./dealerprice')),
                ('model_name', models.CharField(max_length=50)),
                ('variant_name', models.CharField(max_length=50)),
                ('cash_discount', models.DecimalField(decimal_places=8, max_digits=10)),
                ('non_cash_offer', models.DecimalField(decimal_places=8, max_digits=10)),
